...
export async function uploadProjectIcon(projectId: string, ref: string, logo: String): Promise<{ result: boolean }> {
  return axios.post(`/api/projects/${projectId}/logo`, { logo, ref }).then((res) => res.data);
}
