...
export const AI_RUNTIME_COMPONENT_DID = 'z2qa6fvjmjew4pWJyTsKaWFuNoMUMyXDh5A1D';

export const PAGES_KIT_COMPONENT_DID = 'z8iZiDFg3vkkrPwsiba1TLXy3H9XHzFERsP8o';

export const PAGES_KIT_MOUNT_POINT = blocklet?.componentMountPoints.find(
  (i) => i.did === PAGES_KIT_COMPONENT_DID
)?.mountPoint;
