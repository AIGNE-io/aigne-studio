...
import Compare from '../../components/template-form/compare';
  ...
  return (
    <Stack
      ...
      <Compare
        ...
        disabled={disabled}
        path={['model', 'temperature', 'topP', 'presencePenalty', 'frequencyPenalty', 'maxTokens']}>
        <Stack>
          <Typography
            variant="subtitle1"
            sx={{ px: 3, position: 'sticky', top: 48, zIndex: 2, bgcolor: 'background.paper' }}
      ...
      <Compare value={template} originValue={originValue} disabled={disabled} path="datasets">
        <Stack>
          <Typography
            variant="subtitle1"
            sx={{ px: 3, position: 'sticky', top: 48, zIndex: 2, bgcolor: 'background.paper' }}
      ...
      {template.type !== 'image' && (
        <Compare value={template} originValue={originValue} disabled={disabled} path="next">
          <Stack>
            <Typography
              variant="subtitle1"
              sx={{ px: 3, position: 'sticky', top: 48, zIndex: 2, bgcolor: 'background.paper' }}
