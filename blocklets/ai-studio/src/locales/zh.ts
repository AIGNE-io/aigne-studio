...
export default flat({
  ...
  inputParameterLabelPlaceholder: '该参数的名称 (例如: 主题、姓名、年龄)',
  inputParameterKeyPlaceholder: '输入参数的名称',
  inputParameterPlaceholderPlaceholder: '告诉用户怎么填写该字段',
  inputParameterRequiredLabel: '该参数是否必填',
