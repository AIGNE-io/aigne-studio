...
export default flatten({
  ...
  quality: 'Quality',
  qualityTip:
    'The quality of the image that will be generated. auto (default) will automatically select the best quality for the given model. high, medium and low are supported for gpt-image-1. hd and standard are supported for dall-e-3. standard is the only option for dall-e-2.',
  responseFormat: 'Response Format',
  responseFormatTip: 'The format in which the generated images are returned. Must be one of url or b64_json.',
  size: 'Size',
  sizeTip:
    'The size of the generated images. Must be one of 256x256, 512x512, or 1024x1024 for dall-e-2. Must be one of 1024x1024, 1792x1024, or 1024x1792 for dall-e-3 models. Must be one of 1024x1024, 1536x1024, 1024x1536, or auto for gpt-image-1.',
  style: 'Style',
  styleTip:
  ...
  installMoreAgent: 'Install More Agents',
  installMoreModels: 'Install more Models',
  noAgents: 'No Agents',
  buildIn: 'buildIn',
  remote: 'remote',
