...
export default flat({
  ...
  knowledge: {
    ...
    documents: {
      ...
      custom: {
        title: 'Input document content',
        description: 'Input document content, support creation & editing',
      },
    },
    segments: {
      segments: 'Segments',
  ...
  inputParameterKeyPlaceholder: 'Name of the input',
  inputParameterLabelPlaceholder: 'Name of the input (e.g. subject, name, age)',
  inputParameterPlaceholderPlaceholder: 'Describe to the user how to fill in this field',
