...
export default flat({
  ...
  publish: {
    ...
    republishProject: 'Republish',
    updateSuccess: 'Republish Succeed',
    save: 'Save',
    link: 'Link',
    payment: 'Payment',
    price: 'Price',
  ...
  variableParameter: {
    ...
    tool: 'Get variable from Tool',
    datastore: 'Get variable from storage',
    unselect: 'Unselected Tool',
    fromDetail: 'Variable Details',
    setting: 'Settings',
