import { Retriever } from '@aigne/core';

export interface DiscussKitRetrieverResultItem {
  id: string;
  url: string;
  type: string;
  title: string;
...
export class DiscussKitRetriever extends Retriever<DiscussKitRetrieverResultItem> {}
